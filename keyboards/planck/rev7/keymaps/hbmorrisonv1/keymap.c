...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE_LAYER] = LAYOUT_planck_grid(
    KC_TAB,          KC_Q,           KC_W,           TD(TD_F_PGDN),  KC_P,           TD(TD_B_PGUP),   KC_J,    KC_L,            KC_U,          KC_Y,          KC_BSPC,  KC_DEL,
    KC_ESC,          KC_A,           LGUI_T(KC_R),   LALT_T(KC_S),   LCTL_T(KC_T),   KC_G,            KC_M,    RCTL_T(KC_N),    RALT_T(KC_E),  RGUI_T(KC_I),  KC_O,     KC_COLN,
    KC_CAPS,         TD(TD_Z_CAPS),  TD(TD_X_CUT),   TD(TD_C_COPY),  KC_D,           TD(TD_V_PASTE),  KC_K,    KC_H,            KC_COMM,       KC_DOT,        KC_SLSH,  KC_NUBS,
  ...
  [SYM_LAYER] = LAYOUT_planck_grid(
    KC_GRV,          KC_EXLM,  KC_DQUO,  LSFT(KC_3),       KC_DLR,          KC_PERC,  KC_CIRC,  KC_AMPR,        KC_ASTR,  KC_UNDS,  KC_PLUS,  KC_TRNS,
    KC_TRNS,         KC_NO,    KC_PIPE,  TD(TD_LBRC_GLB),  KC_LCBR,         KC_LPRN,  KC_COLN,  KC_AT,          KC_TILD,  KC_MINS,  KC_EQL,   KC_TRNS,
    KC_TRNS,         KC_NO,    KC_NUBS,  TD(TD_RBRC_GRB),  KC_RCBR,         KC_RPRN,  KC_SCLN,  KC_QUOT,        KC_HASH,  KC_GRV,   KC_EXLM,  KC_TRNS,
    TO(FUNC_LAYER),  KC_TRNS,  KC_TRNS,  KC_TRNS,          TO(BASE_LAYER),  KC_TRNS,  KC_TRNS,  TO(NAV_LAYER),  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS
  ),

  [NAV_LAYER] = LAYOUT_planck_grid(
    KC_TRNS,  KC_1,          KC_2,          KC_3,          KC_4,            KC_5,        KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_TRNS,
    KC_TRNS,  LCTL(KC_TAB),  LALT(KC_TAB),  LGUI(KC_TAB),  KC_BTN1,         KC_BTN2,     KC_DEL,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_TRNS,
    KC_TRNS,  KC_TRNS,       KC_TRNS,       M_DSKP,        M_DSKN,          LSFT(KC_V),  KC_INS,   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   KC_TRNS,
  ...
  [FUNC_LAYER] = LAYOUT_planck_grid(
    ...
    KC_TRNS,  KC_F9,    KC_F10,   KC_F11,   KC_F12,          KC_MPRV,  KC_MUTE,  KC_NO,          KC_COMM,  KC_DOT,   KC_SLSH,  KC_TRNS,
